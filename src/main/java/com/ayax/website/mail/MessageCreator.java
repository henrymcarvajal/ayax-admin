...
public class MessageCreator {
    ...
    private static final String NUEVO_COMENTARIO_TEMPLATE = "comentario_nuevo.ftl";
    ...
    public String crearMensajeComentarionNuevo(Conversacion conversacion) {
        Map<String, Object> rootMap = new HashMap<>();
        rootMap.put("conversacion", conversacion);
        ContentGenerator cg = new ContentGenerator();
        return cg.generateFrom(NUEVO_COMENTARIO_TEMPLATE, rootMap);
    }
}
