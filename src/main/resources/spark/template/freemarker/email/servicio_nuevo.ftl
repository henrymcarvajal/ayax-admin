...
<html lang="en">
    ...
    <body>
        ...
        <p>&nbsp;</p>
		<p>&nbsp;Si deseas editar o modificar la solicitud que acabas de hacer, puedes hacerlo entrando al siguiente enlace:</p><br/>
					<center>
                        <a href="${url_ayax}/EditarSolicitud.html?id=${servicio.id}">Ver detalles de la oferta</a>
                    </center>
